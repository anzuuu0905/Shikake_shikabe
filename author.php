        ...
        <section class="blogHead">
          <div class="inner">
            ...
            <div id="pc-categoryLinks" class="pc-categoryLinks">
              ...
              <ul class="categoryLink">
                <li<?php if( $term == 'info' ): ?> class="current"<?php else: endif; ?>><a href="/archives/cate/info/">お知らせ・イベント情報</a></li>
                <li<?php if( $term == 'recruit' ): ?> class="current"<?php else: endif; ?>><a href="/archives/cate/recruit/">海のお仕事情報</a></li>
              </ul>
            </div>
        ...
        <?php the_post(); ?>
              ...
              <li class="col is-mb12 is-pc3">
                ...
                <div class="detail">
                  ...
                  ?>
                  <?php if( has_term( array('blog','tsushin','recipe','relay') ,'cate') ) : ?>
...
<?php wp_pagenavi(); ?>
        ...
        <div class="bnrArea">
          <a href="http://www.town.shikabe.lg.jp/hotnews/detail/00002080.html" target="_blank"><img src="<?php echo $info['themes']; ?>/assets/img/index/bnr.jpg" alt=""></a>
